package batr.menu.objects.selector {
	...
	public class BatrSelectorContent {
		...
		public static function createPositiveIntegerAndOneSpecialContent(initValue: int, tText: TranslationalText): BatrSelectorContent {
		...
		public static function createUnsignedIntegerAndOneSpecialContent(initValue: int, tText: TranslationalText): BatrSelectorContent {
			return new BatrSelectorContent().initAsEnum(
				new < TranslationalText > [
					tText
				], 0, 1
		...
		public static function createBinaryChoiceContent(initValue: int, translations: Translations, tKey0: String, tKey1: String): BatrSelectorContent {
			return new BatrSelectorContent().initAsEnum(new < TranslationalText > [BatrSelectorContent.quickTranslationalTextBuild(tKey0, translations), BatrSelectorContent.quickTranslationalTextBuild(tKey1, translations)], 0, 0).initAsInt(1, 0, initValue).autoInitLoopSelect();
		}

		public static function createYorNContent(initValue: int, translations: Translations): BatrSelectorContent {
			return createBinaryChoiceContent(initValue, translations, TranslationKey.BOOLEAN_NO, TranslationKey.BOOLEAN_YES);
		}

		public static function createBooleanContent(initValue: int, translations: Translations): BatrSelectorContent {
			return createBinaryChoiceContent(initValue, translations, TranslationKey.FALSE, TranslationKey.TRUE);
		}
		...
		//====Enum====//
		public function initAsEnum(texts: Vector.<TranslationalText>, index: int = 0, offset: int = 0): BatrSelectorContent {
		...
		public function alignTranslationsFrom(translations: Translations): BatrSelectorContent {
