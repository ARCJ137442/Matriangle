 ...
 */
export default class WorldRuleEvent extends Event {
	//============Static Variables============//
	...
	override clone(): Event {
		return new WorldRuleEvent(this.type, this.bubbles, this.cancelable);
	}
	...
	override toString(): string {
		return this.formatToString('WorldRuleEvent', 'type', 'bubbles', 'cancelable', 'eventPhase');
	}
}
