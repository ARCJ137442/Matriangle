...
export default class MatrixRuleBatr extends MatrixRule_V1 {
	...
	public static readonly key_playerCount: key = fastAddJSObjectifyMapProperty_dashP(
		this.OBJECTIFY_MAP,
		'playerCount', MatrixRuleBatr.d_playerCount,
	);
	...
	public set playerCount(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_playerCount,
	...
	public set AICount(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_AICount,
				this._AICount, value
			)
		) this._AICount = value;
	}
	...
	public set allowPlayerChangeTeam(value: boolean) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_allowPlayerChangeTeam,
	...
	public set defaultHP(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_defaultHP,
	...
	public set defaultMaxHP(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_defaultMaxHP,
	...
	public set remainLivesPlayer(value: int) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_remainLivesPlayer,
	...
	public set remainLivesAI(value: int) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_remainLivesAI,
	...
	public set defaultRespawnTime(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_defaultRespawnTime,
	...
	public set recordPlayerStats(value: boolean) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_recordPlayerStats,
	...
	public set playerAsphyxiaDamage(value: int) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_playerAsphyxiaDamage,
	...
	public set bonusBoxMaxCount(value: int) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_bonusBoxMaxCount,
	...
	public set bonusBoxSpawnChance(value: number) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_bonusBoxSpawnChance,
	...
	public set bonusBoxSpawnAfterPlayerDeath(value: boolean) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_bonusBoxSpawnAfterPlayerDeath,
	...
	public set bonusBuffAdditionAmount(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_bonusBuffAdditionAmount,
	...
	public set bonusMaxHPAdditionAmount(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_bonusMaxHPAdditionAmount,
	...
	public static readonly key_mapRandomPotentials: key = fastAddJSObjectifyMapProperty_dash2(
		this.OBJECTIFY_MAP,
		'mapRandomPotentials', MatrixRuleBatr.d_mapRandomPotentials,
	...
	public set initialMap(value: IMap | null) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_initialMap,
	...
	public set mapTransformTime(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_mapTransformTime,
	...
	public set enabledTools(value: Tool[]) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_enabledTools,
	...
	public set defaultTool(value: Tool | 'u-random' | 'c-random') {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_defaultTool,
	...
	public set maxLaserLength(value: uint) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_maxLaserLength,
	...
	public set allowLaserThroughAllBlock(value: boolean) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_allowLaserThroughAllBlock,
	...
	public set toolsNoCD(value: boolean) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_toolsNoCD,
	...
	public set allowTeamVictory(value: boolean) {
		if (
			MatrixRuleBatr.preUpdateVariable(
				this, MatrixRuleBatr.key_allowTeamVictory,
