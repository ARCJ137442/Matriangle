...
export default class AIProgram_Adventurer implements IAIProgram {
	//============Static Variables============//
	public static readonly LABEL: string = NativeDecorationLabel.TRIANGLE;
	...
	//============Static Functions============//
	/*========AI Criteria========*/
	static toolUseTestWall(owner: IPlayer | null, host: IBatrWorld, rot: uint, distance: uint): boolean {
	 ...
	 */
	protected static findPath(owner: IPlayer | null, host: IBatrWorld, startX: int, startY: int, endX: int, endY: int): PathNode[] {
	...
	protected static getNearbyNodesAndInitFGH(n: PathNode, host: IBatrWorld, owner: IPlayer | null, target: PathNode): PathNode[] {
	...
	protected static initFGH(n: PathNode, host: IBatrWorld, owner: IPlayer | null, target: iPoint): PathNode {
		// Set Rot in mapDealNode
	...
	protected static mapDealNode(n: PathNode, host: IBatrWorld, fromRot: uint): PathNode {
		n.fromRot = fromRot;
	 ...
	 * @param	node	The node.
	 * @param	host	The host as World.
	 * @param	player	The player.
	 * @return	A int will be multi with G.
	 */
	protected static getPathWeight(node: PathNode, host: IBatrWorld, player: IPlayer): int {
	...
	//========Dynamic A* PathFind========//
	static getDynamicNode(start: iPoint, target: iPoint, host: IBatrWorld, owner: AIPlayer, remember: Vector.<Boolean[]>): PathNode {
	...
	protected static initDynamicNode(n: PathNode, host: IBatrWorld, owner: AIPlayer, target: iPoint): PathNode {
	...
	//============Instance Functions============//
	protected initRemember(host: IBatrWorld): void {
	...
	/*========AI Tools========*/
	public getNearestBonusBox(ownerPoint: iPoint, host: IBatrWorld): BonusBox {
	...
	public getNearestEnemy(owner: IPlayer | null, host: IBatrWorld): IPlayer {
		// getManhattanDistance
	...
	/*====INTERFACE batr.World.AI.IAIPlayerAI====*/
	...
	public requestActionOnTick(player: AIPlayer): AIPlayerAction {
		...
		// Set Variables
		let host: IBatrWorld = player.host;
