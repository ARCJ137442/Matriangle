...
export default class PlayerAttributes implements IJSObjectifiable<PlayerAttributes> {
    ...
    */
    public get buffDamage(): uint { return this._buffDamage; }
    public set buffDamage(value: uint) { this._buffDamage = value; }
    ...
    */
    public get buffCD(): uint { return this._buffCD; }
    public set buffCD(value: uint) { this._buffCD = value; }
    ...
    */
    public get buffResistance(): uint { return this._buffResistance; }
    public set buffResistance(value: uint) { this._buffResistance = value; }
     ...
     * * 算法：最终伤害=max(攻击者伤害-加成值*攻击者武器减免系数 ?? 1, 1)
     */
    public get buffRadius(): uint { return this._buffRadius; }
    public set buffRadius(value: uint) { this._buffRadius = value; }
