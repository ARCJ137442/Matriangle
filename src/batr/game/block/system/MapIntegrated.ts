...
export default abstract class MapIntegrated implements IMap, IMapLogic, IMapStorage {
	...
	public abstract getMapSizeAt(dim: int): int;
	public abstract get randomX(): int;
	public abstract get randomY(): int;
	public abstract get randomPoint(): intPoint;
	public abstract forEachValidPositions_2d(f: (x: int, y: int, ...args: any[]) => void, ...args: any[]): void;
	...
	public abstract hasBlock_2d(x: int, y: int): boolean;
	public abstract getBlock_2d(x: int, y: int): BlockCommon | null;
	public abstract getBlockAttributes_2d(x: int, y: int): BlockAttributes | null;
	public abstract getBlockType_2d(x: int, y: int): Function | null;
	public abstract setBlock_2d(x: int, y: int, block: BlockCommon): void;
	public abstract isVoid_2d(x: int, y: int): boolean;
	public abstract setVoid_2d(x: int, y: int): void;
	...
	public abstract hasSpawnPointAt_2d(x: int, y: int): boolean;
	public abstract addSpawnPointAt_2d(x: int, y: int): void;
	public abstract removeSpawnPoint_2d(x: int, y: int): void;
