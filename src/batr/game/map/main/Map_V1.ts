package batr.game.map.main {
	...
	export default class Map_V1 extends NativeMapCommon {
		//============Static Variables============//
		protected static readonly _SIZE: uint = GlobalGameVariables.DISPLAY_GRIDS;
		...
		protected static isInited: boolean = cInit();
		...
		protected static cInit(): boolean {
			...
			MAP_6.copyContentFrom(FRAME); {
				...
				MAP_6.setBlock(20, 20, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				// 1
				MAP_6.setBlock(20, 9, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				MAP_6.setBlock(20, 14, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				// x+
				MAP_6.setBlock(3, 9, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				MAP_6.setBlock(3, 14, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				// x-
				MAP_6.setBlock(9, 20, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				MAP_6.setBlock(14, 20, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				// y+
				MAP_6.setBlock(9, 3, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				MAP_6.setBlock(14, 3, BlockCommon.fromType(BlockType.COLOR_SPAWNER));

				// y-
				MAP_6.fillBlock(4, 20, 8, 20, BlockType.GLASS);

				MAP_6.fillBlock(15, 20, 19, 20, BlockType.GLASS);

				// #y+
				MAP_6.fillBlock(4, 3, 8, 3, BlockType.GLASS);

				MAP_6.fillBlock(15, 3, 19, 3, BlockType.GLASS);

				// #y-
				MAP_6.fillBlock(20, 4, 20, 8, BlockType.GLASS);

				MAP_6.fillBlock(20, 15, 20, 19, BlockType.GLASS);

				// #x+
				MAP_6.fillBlock(3, 4, 3, 8, BlockType.GLASS);

				MAP_6.fillBlock(3, 15, 3, 19, BlockType.GLASS);
			...
			MAP_7.copyContentFrom(FRAME); {
				...
				// up side
				MAP_7.fillBlock(1, 17, 22, 18, BlockType.WATER);
				...
				MAP_7.fillBlock(9, 11, 9, 12, BlockType.X_TRAP_KILL);

				// x-
				MAP_7.fillBlock(11, 9, 12, 9, BlockType.X_TRAP_KILL);

				// y-
				MAP_7.fillBlock(14, 11, 14, 12, BlockType.X_TRAP_KILL);

				// x+
				MAP_7.fillBlock(11, 14, 12, 14, BlockType.X_TRAP_KILL);
			...
			MAP_9.copyContentFrom(EMPTY); {
				...
				// center
				MAP_9.fillBlock(11, 11, 12, 12, BlockType.COLOR_SPAWNER);
			...
			MAP_B.copyContentFrom(FRAME); {
				...
				// corner spawnpoint
				for (i = 0; i < 4; i++)
					MAP_B.addSpawnPointWithMark(2 + (i >> 1) * 19, 2 + (i & 1) * 19);
		...
		//============Constructor============//
		public constructor(name: string = null, content: object = null, isArena: boolean = false) {
			super(name, isArena);
			if (content != null)
