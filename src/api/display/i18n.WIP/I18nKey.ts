import TypeCommon from '../../../api/server/template/TypeCommon'
...
export default class I18nKey {
	...
	public static readonly REMAIN_LIVES_PLAYER: string =
		'batr.custom.remainLivesPlayer'
	...
	public static readonly BONUS_SPAWN_AFTER_DEATH: string =
		'batr.custom.bonusSpawnAfterPlayerDeath'
	public static readonly MAP_TRANSFORM_TIME: string =
		'batr.custom.mapTransformTime'
	...
	public static readonly ASPHYXIA_DAMAGE: string =
		'batr.custom.asphyxiaDamage'
	...
	public static readonly WIN_SINGLE_PLAYER: string =
		'batr.game.winSinglePlayer'
	...
	// batr.game.key
	public static readonly REMAIN_TRANSFORM_TIME: string =
		'batr.game.key.mapTransformTime'
	public static readonly GAME_DURATION: string = 'batr.game.key.gameDuration'

	// batr.stat
	public static readonly TRANSFORM_MAP_COUNT: string =
		'batr.stat.transformMapCount'
	public static readonly BONUS_GENERATE_COUNT: string =
		'batr.stat.bonusGenerateCount'
	...
	public static readonly DEATH_COUNT_FROM_PLAYER: string =
		'batr.stat.player.deathByPlayerCount'
	...
	public static readonly BE_TELEPORT_COUNT: string =
		'batr.stat.player.beTeleport'
	public static readonly TOTAL_SCORE: string = 'batr.stat.player.totalScore'

	// batr.custom.property
	public static readonly CERTAINLY_DEAD: string =
		'batr.custom.property.certainlyDead'
	public static readonly COMPLETELY_RANDOM: string =
		'batr.custom.property.completelyRandom'
	public static readonly UNIFORM_RANDOM: string =
		'batr.custom.property.uniformRandom'
	...
	public static getTypeKey(type: TypeCommon, isDescription: boolean): string {
		return (
			isDescription
				? I18nKey.getTypeDescriptionKey
				: I18nKey.getTypeNameKey
		)(type)
	}
}
